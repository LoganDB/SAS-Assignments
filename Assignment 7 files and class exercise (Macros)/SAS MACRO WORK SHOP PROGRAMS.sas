...
libname Books "C:\Users\Sumeet Bansal\Google Drive\alabs\Analytics\SAS\Assignments\Assignment 6 files (Macros)\";
...
/* Create a dynaymic report  by using macro variables for the list of books sold in any month and also 
   create a report of how many books sold at the cost above 25 and below 25 in the month 4*/
%let mosold=4;
%let level=25;
